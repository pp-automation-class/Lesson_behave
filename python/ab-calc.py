    ...
    if calc_directions == "1":
        ...
        while True:
            ...
            if type_of_calc == "1":
                ...
                logging.info(f"{answer} miles is {round(answer * conv_rate["ft"], 2)} kilometers")
                time.sleep(2)
                ...
                logging.info(f"{answer} miles is {round(answer * conv_rate["ft"], 2)} meters")
                time.sleep(2)
                ...
                logging.info(f"{answer} inches is {round(answer * conv_rate["ft"], 2)} centimeters")
                time.sleep(2)
